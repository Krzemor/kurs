...
public class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOfUserNoBooks() {
        ...
        LibraryUser user = new LibraryUser("John", "Paul", "123456789");
    ...
    void testListBooksInHandsOfUserOneBook() {
        ...
        LibraryUser user = new LibraryUser("John", "Paul", "123456789");
        List<Book> listOf0Books = new ArrayList<>();
        listOf0Books.add(new Book("Secrets of Alamo", "John Smith", 2008));
        when(libraryDatabaseMock.listBooksInHandsOf(user)).thenReturn(listOf0Books);
        ...
        assertEquals("Secrets of Alamo", booksInHands.get(0).getTitle());
    }
